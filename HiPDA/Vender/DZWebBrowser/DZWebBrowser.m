...
- (NSArray *)items
{
    ...
    _stopButton.tintColor = [UIColor colorWithRed:19.0/255.0 green:108.0/255.0 blue:1.0 alpha:1.0];
    _previousButton.tintColor = [UIColor colorWithRed:19.0/255.0 green:108.0/255.0 blue:1.0 alpha:1.0];
    _nextButton.tintColor = [UIColor colorWithRed:19.0/255.0 green:108.0/255.0 blue:1.0 alpha:1.0];
    ...
    if (_allowSharing) {
        ...
        UIImage *shareImg = [self imageNamed:@"UIButtonBarAction" forBundleNamed:_resourceBundleName];
        _shareButton = [[UIBarButtonItem alloc] initWithImage:shareImg style:UIBarButtonItemStylePlain target:self action:@selector(shareAction:)];
        _shareButton.tintColor = [UIColor colorWithRed:19.0/255.0 green:108.0/255.0 blue:1.0 alpha:1.0];
