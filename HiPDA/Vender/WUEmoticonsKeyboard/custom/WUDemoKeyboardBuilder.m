...
+ (WUEmoticonsKeyboard *)sharedEmoticonsKeyboard {
    ...
    dispatch_once(&onceToken, ^{
        ...
        //Icon keys
        NSArray *iconKeys = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"EmotionIconKeys" ofType:@"plist"]];
        
        NSMutableArray *iconKeyItems = [NSMutableArray array];
        for (NSDictionary *iconInfo in iconKeys) {
